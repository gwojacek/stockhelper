...
def test_att_reviewed_sidetrends_are_persisted_for_both_session_aliases():
    expected = {
        ("2026-02-10", "2026-03-12", "2026-02-16", "2026-03-12"),
        ("not found", "not found", "2026-01-21", "2026-02-13"),
        ("2025-07-25", "2025-09-08", "2025-07-25", "2025-11-27"),
        ("2025-05-13", "2025-06-16", "2025-05-16", "2025-06-13"),
    }
...
def test_sgn_reviewed_sidetrends_are_persisted_for_both_session_aliases():
    expected = {
        ("2026-06-08", "2026-07-31", "2026-07-23", "2026-08-18"),
        ("2026-02-13", "2026-04-02", "2026-02-13", "2026-04-15"),
        ("2025-10-13", "2025-11-06", "2025-10-13", "2025-11-06"),
        ("2025-05-15", "2025-06-13", "2025-05-19", "2025-06-13"),
    }
    invalid = {("2025-07-04", "2025-08-18")}

    assert _session_ranges("sgn.json") == (expected, invalid)
    assert _session_ranges("sgn_wa.json") == (expected, invalid)
