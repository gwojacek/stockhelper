...
- Updated README usage to make Docker + `stock` the easiest path, including a quick command table, update workflow after `git pull`, report/browser behavior, permissions, cleanup, and plain Docker alternatives.
