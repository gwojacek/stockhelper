...
- The chart toolbar includes **⬇ PNG** for downloading the currently visible chart directly from the browser. After a position is calculated, the downloaded PNG also includes the complete position-sizing table. **Reset Fibo** or **Reset scanner** restores the original scanner-drawn structure.
