...
- generate compact Trójpolówki (3P) Fibo/Ichimoku watchlists plus dedicated Kliny and persistent Favorites tabs from the latest allsearch data, with searchable/filterable HTML tabs, checked-instrument lists, and grouped quick-chart buttons;
