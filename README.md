...
- scan market groups for Ichimoku cloud, Fibonacci setups, and falling-wedge (Kliny) formations with age-aware breakout/retest handling, a five-day invalid-save warning lifecycle, wick-based stop validation, structural Fibo re-anchoring around monthly ranges, saved manual wedges, and alternate-wedge review;
...
- **Fibonacci formation scanner** with long setups across supported markets, regular mirrored-short search for forex, commodities, DAX40, and US100, and directional short 3P impulse discovery for stocks; movable early/23.6/61.8 lifecycle states; one-, two-, and three-candle reversal windows in which any pattern candle may touch 61.8; confirming-candle pattern dates; wick-based post-pattern stop invalidation; later-extreme and structural re-anchoring; completed month-range rejection; saved chart-anchor overrides that receive a visible five-day invalid warning before automatic removal; and an explain/debug mode.
