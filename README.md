...
- scan market groups for Ichimoku cloud, Fibonacci setups, and falling-wedge (Kliny) formations with age-aware breakout/retest handling, saved chart-drawing overrides, stale-Fibo-anchor rejection, improved 5.0 wedge anchor scoring, and alternate-wedge review;
