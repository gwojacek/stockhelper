...
def calculate_investment(entry_price, stop_loss_price, initial_capital, risk_levels, lot_price, pip_value, spread):
    ...
    for risk in risk_levels:
        ...
        def calculate_loss_for_lots(lots):
            ...
            loss_per_lot = (stop_loss_price - entry_price) * adjusted_pip_value # Changed for short position
            spread_loss_entry = spread * lots
            spread_loss_exit = (spread * lots) * (stop_loss_price/entry_price) # Spread cost at stop loss level, changed calculation for short position
