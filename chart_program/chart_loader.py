...
# A cache with more than five Yahoo-shaped rows in its latest 50 candles is
# rebuilt from Stooq before Yahoo's one live candle is merged back in.
YAHOO_RECENT_CANDLE_WINDOW = 50
YAHOO_RECENT_CANDLE_REBASE_THRESHOLD = 6
